...
var LevenshteinDistance = /** @class */ (function () {
     ...
     */
    LevenshteinDistance.prototype.LevenshteinDistance = function (threshold) {
     ...
     */
    LevenshteinDistance.prototype.apply = function (left, right) {
     ...
     */
    LevenshteinDistance.getDefaultInstance = function () {
     ...
     */
    LevenshteinDistance.prototype.getThreshold = function () {
     ...
     * @return result distance, or -1
     */
    LevenshteinDistance.limitedCompare = function (left, right, threshold) {
        ...
        var p = util_1.createArray(n + 1, 0); // 'previous' cost array, horizontally
     ...
     */
    LevenshteinDistance.unlimitedCompare = function (left, right) {
        if (left == null || right == null) {
            throw new Error("CharSequences must not be null");
        }
        /*
     ...
     * Default instance.
     */
    LevenshteinDistance.DEFAULT_INSTANCE = new LevenshteinDistance();
